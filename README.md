...
## Setup
*Skip whatever step that you have already done before.* 
...
- The Alchemy API can be obtained by creating an Alchemy account, then creating an app, and you can copy the token from the dashboard.
...
Star this [Github Repository](https://github.com/aeither/dungeon3).
